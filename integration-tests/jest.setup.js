...
try { // integration-test logconfig
  ...
  try { // falling back to app logconfig
    ...
    log(`you have not configured any LOGCONFIG.js. as a result of this,
    you're going to have quite verbose logs in your tests. if you wish, you
    can turn log namespaces and levels on/off by creating a file
    <repo-root>/integration-tests/LOGCONFIG.js and putting in it a
    'debug'-formatted LOGCONFIG. see LOGCONFIG.example.js for inspiration.`)
  }
}
